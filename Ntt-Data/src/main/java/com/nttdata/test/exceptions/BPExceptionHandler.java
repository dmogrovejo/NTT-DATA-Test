...
public class BPExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(HttpMediaTypeNotSupportedException ex,
		...
		ApiNttDataError err = new ApiNttDataError(LocalDateTime.now(), HttpStatus.BAD_REQUEST, "Invalid JSON", details);
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		ApiNttDataError err = new ApiNttDataError(LocalDateTime.now(), HttpStatus.BAD_REQUEST, "Malformed JSON request", details);
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		ApiNttDataError err = new ApiNttDataError(LocalDateTime.now(), HttpStatus.BAD_REQUEST, "Validation Errors", details);
	...
	protected ResponseEntity<Object> handleMissingServletRequestParameter(MissingServletRequestParameterException ex,
		...
		ApiNttDataError err = new ApiNttDataError(LocalDateTime.now(), HttpStatus.BAD_REQUEST, "Missing Parameters", details);
	...
	protected ResponseEntity<Object> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex,
		...
		ApiNttDataError error = new ApiNttDataError(LocalDateTime.now(), HttpStatus.BAD_REQUEST, "Mismatch Type", details);
	...
	public ResponseEntity<?> handleConstraintViolationException(Exception ex, WebRequest request) {
		...
		ApiNttDataError err = new ApiNttDataError(LocalDateTime.now(), HttpStatus.BAD_REQUEST, "Constraint Violation", details);
	...
	public ResponseEntity<Object> handleAccountException(AccountException ex) {
		...
		ApiNttDataError err = new ApiNttDataError(LocalDateTime.now(), HttpStatus.PRECONDITION_FAILED, "Pre condition failed: ", details);
	...
	public ResponseEntity<Object> handleResourceNotFoundException(ResourceNotFoundException ex) {
		...
		ApiNttDataError err = new ApiNttDataError(LocalDateTime.now(), HttpStatus.NOT_FOUND, "Resource Not Found", details);
	...
	protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers,
		...
		ApiNttDataError err = new ApiNttDataError(LocalDateTime.now(), HttpStatus.BAD_REQUEST, "Method Not Found", details);
	...
	public ResponseEntity<Object> handleAll(Exception ex, WebRequest request) {
		...
		ApiNttDataError err = new ApiNttDataError(LocalDateTime.now(), HttpStatus.BAD_REQUEST, "Error occurred", details);
